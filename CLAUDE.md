...
- **Current version:** `0.4.1-alpha` (see `Cargo.toml`, `CHANGELOG.md`).
- **Last tag:** `v0.4.0-alpha` — v0.4.1-alpha is staged on branch
  `release/0.4.1-alpha` and not yet pushed as a tag.
- **Docs:** the mdBook under `book/src/` is authoritative for
  ...
  as of 0.4.1-alpha). No auto-regeneration hook wired up.
